function quantify_xcorr_other_immobility_batch(saveFolder)
...
thresh.min_imm_samp     = params.xcorr.win_samples;
...
for n = 1:size(ref,1)
    ...
    % main function
    %out = quantify_xcorr_other_immobility(cdata,speed,xpos,ypos,thresh);
    out = quantify_xcorr_other_immobility_slidingwin(cdata,speed,xpos,ypos,thresh);
